	...
	<div class="condition">
		...
		<div class="sl">
		   <ul>
		   	...
		   	<li><a href="">不限</a></li>
            <li><a href="/SuperMarket/InfoByNet?net=联通3G">联通3G</a></li>
		   	<li><a href="/SuperMarket/InfoByNet?net=电信3G">电信3G</a></li>
		   	<li><a href="/SuperMarket/InfoByNet?net=移动3G">移动3G</a></li>
		...
		<div class="sl">
			<ul>
			 ...
			 <li><a href="/SuperMarket/InfoByPrice?price=&gt4999">>4999</a></li>
			</ul>
		</div>
		<div class="sl">
			<ul>
				...
				<li><a href="/SuperMarket/InfoByOs?os=WindowPhone">WindowPhone</a></li>
				<li><a href="/SuperMarket/InfoByOs?os=Symbian">Symbian</a></li>
				<li><a href="/SuperMarket/InfoByOs?os=BlackBarry OS">BlackBarry OS</a></li>
	            <li><a href="/SuperMarket/InfoByOs?os=Palm OS">Palm OS</a></li>
			</ul>
		</div>
	</div>
...
Collection cl=shopping.getgoods();
    ...
    double gprice=goods.getGprice();
     %>
		<div class="p1-show">
			...
			<div class="p-desc">
			    <div><a href="/SuperMarket/servlet/ProductInfo?pname=<%=gname %>"><%=gname %></a></div>
			    <div>价格：<%=gprice %></div>
			</div>
		</div>
		<%
