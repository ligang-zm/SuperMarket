...
<div class="show1">
	...
	<c:if test="${null!=sessionScope.listGoods}">
		<c:forEach var="goods" items="${sessionScope.listGoods}"
							varStatus="status" step="1">
		<div class="p1-show">
			<div class="p-img">
			  <img src="${goods.gimage}" width="160px" height="160px"/>
			</div>
			<div class="p-desc">
			    <div><a href="/SuperMarket/ProductInfo?pname=<c:out value='${goods.gname}'></c:out>">${goods.gname}</a></div>
